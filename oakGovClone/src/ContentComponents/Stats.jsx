    ...
    <>
          ...
          <article id="statContainer">
            <div className="statItem">
              ...
              <div className="statCard">
                ...
                <p>Nearly 7,300 residents received these new Health360 services in 2022 at our clinics in Pontiac and Southfield.</p>
              </div>
            </div>
            ...
            <div className="statItem">
              ...
              <div className="statCard">
                ...
                <p>Oakland County has more than 39,000 small businesses, 95% have fewer than 50 employees.</p>
              </div>
            </div>
            ...
            <div className="statItem">
              ...
              <div className="statCard">
                ...
                <p>68.4% of Oakland County residents hold a post-secondary education. Our goal is 80% by 2030.</p>
              </div>
            </div>
          </article>
      </section>
      ...
      <section id="subscribe">
        <article>
          ...
          <p>Want to stay up to date on county news, events, and services? Sign up for our e-newsletter, which delivers the latest county news directly to your inbox.</p>
